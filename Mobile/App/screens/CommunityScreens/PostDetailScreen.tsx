...
const PostDetailScreen: React.FC = ({ route }: any) => {
    ...
    const DeatilPost = async () => {
        try {
            const response = await fetch('http://172.16.117.122:3000/get_post_detail', {
                method: 'POST',
                headers: {
    ...
    const CommentList = async () => {
        try {
            const response = await fetch('http://172.16.117.122:3000/get_comment', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const reCommentList = async () => {
        try {
            const response = await fetch('http://172.16.117.122:3000/get_recomment', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
