    ...
    const StudentInfoScreen = ({route, navigation} : any) => {
        ...
        const get_user_university = async () => {
            try {
            const response = await fetch('http://192.168.35.83:3000/get_university_name', {
                method: 'POST',
                headers: {
        ...
        const DeleteUser = async () => {
            try {
                const response = await fetch('http://192.168.35.83:3000/delete_user', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
        ...
        const UpdateAccount = async () => {
            try {
            const response = await fetch('http://192.168.35.83:3000/updateAccount', {
                method: 'POST',
                headers: {
                'Content-Type': 'application/json',
                },
    ...
    const UpdateImg = async() => {
        try {
            const response = await fetch('http://192.168.35.83:3000/updateImg', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
