...
const ItemRegistration: React.FC = ({ route, navigation }: any) => {
  ...
  const get_event_obj = async () => {
    try {
      const response = await fetch('http://172.16.108.18:3000/get_event_obj', {
        method: 'POST',
        headers: {
  ...
  const getBarcordMaxNum = async () => {
    try {
      const response = await fetch('http://172.16.108.18:3000/getMaxBarcordNum');
      if (!response.ok) {
  ...
  const PostItemObject = async () => {
    ...
    try {
      const response = await fetch('http://172.16.108.18:3000/postItem', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const DeleteItemOject = async (itemData : any) => {
    try {
      const response = await fetch('http://172.16.108.18:3000/deleteItem', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const UpdateItemOject = async () => {
    try {
      const response = await fetch('http://172.16.108.18:3000/updateItem', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
